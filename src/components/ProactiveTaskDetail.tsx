...
import { MessageSquare, AlertTriangle, Brain, MessageCircle, X } from 'lucide-react'
...
interface ProactiveTaskDetailProps {
  taskId: string
}
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs text-gray-500 bg-purple-100 text-purple-700 px-2 py-1 rounded font-semibold">
                  PROACTIVE
                </span>
...
export default ProactiveTaskDetail
